! vmpi_commtest_p4.f90
! Phase 4: comm = MPI_Comm_split(color=k, key=i),  hipDevSync BEFORE IRECVs
! Expected: PASS for all 48 ranks — this is the proposed fix
! Output: fort.4XX where XX = rank (fort.400 to fort.447)
!
...
program vmpi_commtest_p4
    ...
    integer, parameter :: FUNIT_BASE = 400   ! fort.400 + rank
    ...
    ! --- Test comm: fresh MPI_Comm_split (no lineage from Cartesian comms) ---
