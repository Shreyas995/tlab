! vmpi_nodewin.f90
! ============================================================================
! Option 1 validation: node-local shared-window GPU writes for the K-transpose
! INTRA-NODE peers, on a 2-node job. This is the apudirect mechanism applied to
! a 24-rank NODE-local sub-comm of a multi-node job -- what fabricdirect-K *should*
! do for its intra-node K-peers (it currently routes ALL K-peers through MPI).
!
...
!   Q3  Does the K intra-node leg deliver correctly?  -> [VERIFY] errors==0
!
