...
contains
    ...
    subroutine FDM_C2N4_Jacobian(nx, dx, lhs, rhs, nb_diag, coef, periodic)
        ...
        if (periodic_loc) then
            call Create_System_2der5(dx, lhs, rhs(:, 1:5), rhs(:, 6:8), coef)
            ...
            call Create_System_2der5(dx, lhs, rhs(:, 1:5), rhs(:, 6:8), coef, coef_bc1)
    ...
    subroutine FDM_C2N6_Jacobian(nx, dx, lhs, rhs, nb_diag, coef, periodic)
        ...
        if (periodic_loc) then
            ...
            call Create_System_2der5(dx, lhs, rhs(:, 1:5), rhs(:, 6:8), coef, coef_bc1, coef_bc2)
    ...
    subroutine FDM_C2N6_Hyper_Jacobian(nx, dx, lhs, rhs, nb_diag, coef, periodic)
        ...
        if (periodic_loc) then
            call Create_System_2der7(dx, lhs, rhs(:, 1:7), rhs(:, 8:10), coef)
            ...
            call Create_System_2der7(dx, lhs, rhs(:, 1:7), rhs(:, 8:10), coef, coef_bc1, coef_bc2, coef_bc3)
