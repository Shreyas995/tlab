...
contains
    ...
    subroutine FDM_Int2_Solve_APU(nlines, ilines, klines, fdmi_int2, rhsi, f, result, p2_wrk2d)
        ...
        DNS_PROBE('POIS-solve:0-input-f', f(1, 1, 1), 2*nx*klines*ilines, -1)
        select case (ndr)
        case (3)
        ...
        DNS_PROBE('POIS-solve:1-post-matmul', result(1, 1, 1), 2*nx*klines*ilines, -1)
        ...
        DNS_PROBE('POIS-solve:2-post-thomas', result(1, 1, 1), 2*nx*klines*ilines, -1)
        ...
        DNS_PROBE('POIS-solve:3-post-correction', result(1, 1, 1), 2*nx*klines*ilines, -1)
